...
JMXTRANS_OPTS=${JMXTRANS_OPTS:-"-Djmxtrans.log.level=${LOG_LEVEL} -Djmxtrans.log.dir=$LOG_DIR -Dport1=$port1 -Durl1=$url1 -Dnode_alias=$node_alias -DinfluxUrl=$influxUrl -DinfluxDb=$influxDb -DinfluxUser=$influxUser -DinfluxPwd=$influxPwd" }
